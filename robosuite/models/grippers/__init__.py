...
from .mycobot280_gripper import Mycobot280Gripper
from .mycobot_parallel_gripper import MycobotParallelGripper
...
GRIPPER_MAPPING = {
    ...
    "Mycobot280Gripper": Mycobot280Gripper,
    "MycobotParallelGripper": MycobotParallelGripper,
    None: NullGripper,
}
